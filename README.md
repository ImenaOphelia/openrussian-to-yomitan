...
```
# Attribution
* `generate_dict.py`, `utils.py` and `get_csv.py` were originally shared by @Holence in the [OpenRussian_MDict](https://github.com/Holence/OpenRussian_MDict) repo (CC-BY-SA 4.0).
